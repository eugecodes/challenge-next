...
const DarkModeToggle = ({ theme, id, className }) => {
  ...
  return (
    <>
      <Head>
        {darkMode.value ? (
          <>
            ...
            <link
              rel="mask-icon"
              href="/dark-safari-pinned-tab.png"
              color="#5bbad5"
            />
          ...
          <>
            ...
            <link
              rel="mask-icon"
              href="/light-safari-pinned-tab.png"
              color="#5bbad5"
            />
            <meta name="msapplication-TileColor" content="#da532c" />
      ...
      <div className={clsx("dark-mode-toggle", className)}>
        ...
        <Toggle id={id} checked={darkMode.value} onChange={darkMode.toggle} />
