...
const ListActions = ({ listId, page, listName, creatorAccountId }) => {
    ...
    <>
      ...
      <Navbar>
        {listActions.map((listAction) => (
          <NavbarItem key={listAction.title} invisible={listAction.invisible}>
            {listAction.href ? (
              ...
              <a>
                <TextButton style={{ padding: 0 }} onClick={listAction.onClick}>
                  {listAction.title}
                </TextButton>
              </a>
            )}
