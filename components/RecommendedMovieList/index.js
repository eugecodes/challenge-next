...
const RecommendedMovieList = ({ recommendedMovies, baseUrl }) => (
  <PaddingWrapper>
    ...
    {recommendedMovies.loading ? (
      ...
      <NotFound title="Sorry!" subtitle="There are no recommended movies..." />
    ) : (
      <MovieList movies={recommendedMovies} baseUrl={baseUrl} />
    )}
  </PaddingWrapper>
);
